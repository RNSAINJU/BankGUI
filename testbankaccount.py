...
class TestBankAcount(unittest.TestCase):
    ...
    def test_legal_deposit_works(self):
        ...
        assert self.account.balance == 7000.0
    ...
    def test_illegal_deposit_raises_exception(self):
        ...
        # raised.
        self.assertRaises(ValueError,self.account.deposit, "text" )
    ...
    def test_legal_withdrawal(self):
        ...
        assert self.account.balance == 5000.0
    ...
    def test_illegal_withdrawal(self):
        ...
        self.assertRaises(ValueError,self.account.withdraw, "text" )
    ...
    def test_insufficient_funds_withdrawal(self):
        ...
        self.assertRaises(ValueError,self.account.withdraw, 10000 )
